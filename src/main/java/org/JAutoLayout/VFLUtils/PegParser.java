...
import org.JAutoLayout.VFLUtils.Grammar.CommaPredicate;
import org.JAutoLayout.VFLUtils.Grammar.Connection;
import org.JAutoLayout.VFLUtils.Grammar.ConnectionSuperView;
import org.JAutoLayout.VFLUtils.Grammar.ConnectionView;
import org.JAutoLayout.VFLUtils.Grammar.Connector;
import org.JAutoLayout.VFLUtils.Grammar.ConnectorWrappedPredicateList;
import org.JAutoLayout.VFLUtils.Grammar.EmptyString;
import org.JAutoLayout.VFLUtils.Grammar.ObjectOfPredicate;
import org.JAutoLayout.VFLUtils.Grammar.Orientation;
import org.JAutoLayout.VFLUtils.Grammar.Predicate;
import org.JAutoLayout.VFLUtils.Grammar.PredicateList;
import org.JAutoLayout.VFLUtils.Grammar.PredicateListWithParens;
import org.JAutoLayout.VFLUtils.Grammar.Priority;
import org.JAutoLayout.VFLUtils.Grammar.Relation;
import org.JAutoLayout.VFLUtils.Grammar.StrPriority;
import org.JAutoLayout.VFLUtils.Grammar.SuperView;
import org.JAutoLayout.VFLUtils.Grammar.SuperViewConnection;
import org.JAutoLayout.VFLUtils.Grammar.View;
import org.JAutoLayout.VFLUtils.Grammar.ViewName;
import org.JAutoLayout.VFLUtils.Grammar.VisualFormatString;
...
public class PegParser implements org.rekex.parser.PegParser<VisualFormatString>
{
    ...
    static _State rule_43(_State state) throws _FatalEx
    {
        ...
        org.JAutoLayout.VFLUtils.Grammar.Number value;
        try{
            value = new org.JAutoLayout.VFLUtils.Grammar.Number(arg_0);
        }catch(Exception ex){
            throw new _FatalEx(start0, ex);
        }
        return state.ok(value);
    ...
    static class _DatatypeList
    {
        ...
        static org.JAutoLayout.VFLUtils.Grammar.VisualFormatString t_0;
        // [1] Opt<Orientation>
        static org.rekex.helper.datatype.Opt<org.JAutoLayout.VFLUtils.Grammar.Orientation> t_1;
        // [2] Opt<SuperViewConnection>
        static org.rekex.helper.datatype.Opt<org.JAutoLayout.VFLUtils.Grammar.SuperViewConnection> t_2;
        // [3] View
        static org.JAutoLayout.VFLUtils.Grammar.View t_3;
        // [4] List<ConnectionView>
        static java.util.List<org.JAutoLayout.VFLUtils.Grammar.ConnectionView> t_4;
        // [5] Opt<ConnectionSuperView>
        static org.rekex.helper.datatype.Opt<org.JAutoLayout.VFLUtils.Grammar.ConnectionSuperView> t_5;
        // [6] Some<Orientation>
        static org.rekex.helper.datatype.Opt.Some<org.JAutoLayout.VFLUtils.Grammar.Orientation> t_6;
        // [7] None<Orientation>
        static org.rekex.helper.datatype.Opt.None<org.JAutoLayout.VFLUtils.Grammar.Orientation> t_7;
        // [8] Some<SuperViewConnection>
        static org.rekex.helper.datatype.Opt.Some<org.JAutoLayout.VFLUtils.Grammar.SuperViewConnection> t_8;
        // [9] None<SuperViewConnection>
        static org.rekex.helper.datatype.Opt.None<org.JAutoLayout.VFLUtils.Grammar.SuperViewConnection> t_9;
        // [10] @Ch("[")char
        static @org.rekex.helper.anno.Ch(except="", ignoreCase=false, range={}, value="[")char t_10;
        // [11] ViewName
        static org.JAutoLayout.VFLUtils.Grammar.ViewName t_11;
        // [12] Opt<PredicateListWithParens>
        static org.rekex.helper.datatype.Opt<org.JAutoLayout.VFLUtils.Grammar.PredicateListWithParens> t_12;
        // [13] @Ch("]")char
        static @org.rekex.helper.anno.Ch(except="", ignoreCase=false, range={}, value="]")char t_13;
        // [14] ConnectionView
        static org.JAutoLayout.VFLUtils.Grammar.ConnectionView t_14;
        // [15] Some<ConnectionSuperView>
        static org.rekex.helper.datatype.Opt.Some<org.JAutoLayout.VFLUtils.Grammar.ConnectionSuperView> t_15;
        // [16] None<ConnectionSuperView>
        static org.rekex.helper.datatype.Opt.None<org.JAutoLayout.VFLUtils.Grammar.ConnectionSuperView> t_16;
        // [17] Orientation
        static org.JAutoLayout.VFLUtils.Grammar.Orientation t_17;
        // [18] SuperViewConnection
        static org.JAutoLayout.VFLUtils.Grammar.SuperViewConnection t_18;
        ...
        static org.rekex.helper.datatype.Opt.Some<org.JAutoLayout.VFLUtils.Grammar.PredicateListWithParens> t_20;
        // [21] None<PredicateListWithParens>
        static org.rekex.helper.datatype.Opt.None<org.JAutoLayout.VFLUtils.Grammar.PredicateListWithParens> t_21;
        // [22] Connection
        static org.JAutoLayout.VFLUtils.Grammar.Connection t_22;
        // [23] ConnectionSuperView
        static org.JAutoLayout.VFLUtils.Grammar.ConnectionSuperView t_23;
        // [24] @Str({"H","V"})String
        ...
        // [26] SuperView
        static org.JAutoLayout.VFLUtils.Grammar.SuperView t_26;
        // [27] PredicateListWithParens
        static org.JAutoLayout.VFLUtils.Grammar.PredicateListWithParens t_27;
        // [28] ConnectorWrappedPredicateList
        static org.JAutoLayout.VFLUtils.Grammar.ConnectorWrappedPredicateList t_28;
        // [29] Connector
        static org.JAutoLayout.VFLUtils.Grammar.Connector t_29;
        // [30] EmptyString
        static org.JAutoLayout.VFLUtils.Grammar.EmptyString t_30;
        // [31] @Ch("|")String
        ...
        // [33] Predicate
        static org.JAutoLayout.VFLUtils.Grammar.Predicate t_33;
        // [34] List<CommaPredicate>
        static java.util.List<org.JAutoLayout.VFLUtils.Grammar.CommaPredicate> t_34;
        // [35] @Ch(")")char
        static @org.rekex.helper.anno.Ch(except="", ignoreCase=false, range={}, value=")")char t_35;
        // [36] PredicateList
        static org.JAutoLayout.VFLUtils.Grammar.PredicateList t_36;
        // [37] @Ch("-")char
        ...
        // [39] Opt<Relation>
        static org.rekex.helper.datatype.Opt<org.JAutoLayout.VFLUtils.Grammar.Relation> t_39;
        // [40] ObjectOfPredicate
        static org.JAutoLayout.VFLUtils.Grammar.ObjectOfPredicate t_40;
        // [41] Opt<StrPriority>
        static org.rekex.helper.datatype.Opt<org.JAutoLayout.VFLUtils.Grammar.StrPriority> t_41;
        // [42] CommaPredicate
        static org.JAutoLayout.VFLUtils.Grammar.CommaPredicate t_42;
        // [43] Number
        static org.JAutoLayout.VFLUtils.Grammar.Number t_43;
        // [44] Some<Relation>
        static org.rekex.helper.datatype.Opt.Some<org.JAutoLayout.VFLUtils.Grammar.Relation> t_44;
        // [45] None<Relation>
        static org.rekex.helper.datatype.Opt.None<org.JAutoLayout.VFLUtils.Grammar.Relation> t_45;
        // [46] Some<StrPriority>
        static org.rekex.helper.datatype.Opt.Some<org.JAutoLayout.VFLUtils.Grammar.StrPriority> t_46;
        // [47] None<StrPriority>
        static org.rekex.helper.datatype.Opt.None<org.JAutoLayout.VFLUtils.Grammar.StrPriority> t_47;
        // [48] @Ch(",")char
        ...
        // [50] Relation
        static org.JAutoLayout.VFLUtils.Grammar.Relation t_50;
        // [51] StrPriority
        static org.JAutoLayout.VFLUtils.Grammar.StrPriority t_51;
        // [52] @Str({"==","<=",">="})String
        ...
        // [54] Priority
        static org.JAutoLayout.VFLUtils.Grammar.Priority t_54;
        // [55] @Regex("[0-9]+")String
